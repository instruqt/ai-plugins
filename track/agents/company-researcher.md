...
1. Read the manifest: `${TRACK_RESEARCH_DIR}/<company-slug>/manifest.json` to understand what domains were scraped and their relationships
...
4. Focus on the **primary domain's** directory: `${TRACK_RESEARCH_DIR}/<company-slug>/website/<primary-domain>/`
